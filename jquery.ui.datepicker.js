...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Enero","Febrero","Marzo","Abril","Mayo","Junio",
			"Juloi","Augosto","Septiembre","Octubre","Noviembre","Diciembre"], // Names of months for drop-down and formatting
		...
		dayNamesShort: ["Dom", "Lun", "Mar", "Mié", "Jue", "Vie", "Sab"], // For formatting
